...
export function Registration() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10 bg-[#f4f1e8] p-12 md:p-24 space-y-10">
        <div className="text-center space-y-4">
          <p className="font-title text-sm uppercase tracking-[0.4em] text-[#0969a7]">Registro abierto</p>
          <h2 className="font-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#ff7300] uppercase tracking-[0.028em] leading-tight md:leading-[1.3] break-words hyphens-auto heading-balanced">
            Únete al movimiento
          </h2>
          <p className="font-body text-base sm:text-lg md:text-xl text-slate-900 heading-balanced">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="space-y-4">
            <h3 className="font-title text-xl uppercase tracking-[0.3em] text-[#0969a7]">¿Qué harás?</h3>
            <ul className="space-y-3">
              {steps.map((step) => (
                <li key={step} className="flex gap-3 text-left">
                  <span className="mt-1 h-2 w-2 bg-[#0969a7] flex-none" aria-hidden></span>
                  <span className="font-body text-base md:text-lg text-slate-900">{step}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-title text-xl uppercase tracking-[0.3em] text-[#0969a7]">Requisitos rápidos</h3>
            <ul className="space-y-3">
              {reminders.map((item) => (
                <li key={item} className="flex gap-3 text-left">
                  <span className="mt-1 h-2 w-2 bg-[#ff7300] flex-none" aria-hidden></span>
                  <span className="font-body text-base md:text-lg text-slate-900">{item}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-slate-500">El formulario se abrirá en una pestaña nueva.</p>
        </div>
      </div>
    </SectionWrapper>
  );
